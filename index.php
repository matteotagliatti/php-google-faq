...
<body>
    <header>
        <h1 class="top">Google Privacy e termini</h1>
        <nav class="bottom">
            <ul>
                <li>Introduzione</li>
